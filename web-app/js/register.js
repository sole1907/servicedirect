...
// initialize tooltipster on input elements
    $('#registerForm input').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right',
        touchDevices: false
    ...
    $("#registerForm").validate({
        ...
        rules: {
            ...
            username: {
                //remote: "/servicedirect/webresources/users/exists/" + $("#registerForm\\:email").val()
                emailExists: true
            }
        },
        messages: {
    ...
    $('#changePasswordForm input').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
    // initialize tooltipster on select elements
    $('#changePasswordForm select').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
    ...
    $('#registerForm\\:servicetype').change(function () {
        if ($(this).val() === "") {
