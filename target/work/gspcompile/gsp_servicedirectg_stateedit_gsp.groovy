...
class gsp_servicedirectg_stateedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',17,['bean':(stateInstance),'var':("error")],3)
printHtmlPart(13)
})
invokeTag('hasErrors','g',19,['bean':(stateInstance)],2)
printHtmlPart(6)
createTagBody(2, {->
printHtmlPart(14)
invokeTag('hiddenField','g',21,['name':("version"),'value':(stateInstance?.version)],-1)
printHtmlPart(14)
...
invokeTag('form','g',29,['url':([resource:stateInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1446225970598L
