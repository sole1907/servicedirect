...
class gsp_servicedirectg_secUseredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/secUser/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',40,['url':([resource:secUserInstance, action:'update']),'method':("PUT"),'id':("registeruserForm")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1445784345778L
