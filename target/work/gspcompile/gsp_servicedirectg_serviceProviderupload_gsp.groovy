...
class gsp_servicedirectg_serviceProviderupload_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/serviceProvider/upload.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('javascript','g',9,['src':("serviceproviders.js")],-1)
printHtmlPart(5)
})
...
createTagBody(2, {->
printHtmlPart(18)
invokeTag('render','g',70,['template':("uploadform")],-1)
printHtmlPart(19)
invokeTag('submitButton','g',74,['name':("create"),'class':("save"),'value':(message(code: 'default.button.submit.label', default: 'Submit'))],-1)
printHtmlPart(20)
})
invokeTag('form','g',78,['url':([resource:serviceProviderInstance, action:'processUpload']),'enctype':("multipart/form-data"),'id':("uploadForm")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1446053778489L
