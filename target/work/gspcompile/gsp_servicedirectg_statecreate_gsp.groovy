...
class gsp_servicedirectg_statecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',16,['bean':(stateInstance),'var':("error")],3)
printHtmlPart(13)
})
invokeTag('hasErrors','g',18,['bean':(stateInstance)],2)
printHtmlPart(6)
createTagBody(2, {->
printHtmlPart(14)
...
invokeTag('form','g',27,['url':([resource:stateInstance, action:'save'])],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1446225139094L
