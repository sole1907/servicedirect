...
class gsp_servicedirectg_secUseradmincreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/secUser/admincreate.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('javascript','g',9,['src':("registeruser.js")],-1)
printHtmlPart(5)
})
...
createTagBody(2, {->
printHtmlPart(18)
invokeTag('render','g',61,['template':("form"),'model':([create:true])],-1)
printHtmlPart(19)
invokeTag('submitButton','g',65,['name':("create"),'class':("save"),'value':(message(code: 'default.button.submit.label', default: 'Submit'))],-1)
printHtmlPart(20)
})
invokeTag('form','g',69,['url':([resource:secUserInstance, action:'save']),'id':("registeruserForm")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1446584707849L
